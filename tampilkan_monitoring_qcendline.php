            ...
            <div class="container-fluid">
                <div class="row">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h3>
                                            <center><strong class="animated-title" id="chartTitle">TODAY & YESTERDAY OUTPUT CHART </strong></center>
                                        </h3>
                    ...
                    <div class="col-md-5">
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                <h2><center><i class="fas fa-bullhorn"></i> QC ENDLINE OUTPUT</center></h2>
                                <br>
