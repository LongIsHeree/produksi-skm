...
<div id="tableContainer">
              ...
              foreach ($kdlabel as $label => $data) {
                ...
                <table class='hlap' width='100%'>
                  <tr>
                    <td width='10%'>ORC</td>
                    <td width='1%'>:</td>
                    <td width='20%' align='left'><?= $orc2 ?> </td>
                    <td width='55%'></td>
                  ...
                  <tr>
                    ...
                    <td width='1%'>:</td>
                    <td width='20%' align='left'><?= $style2 . ' ( ' . $color ?> ) </td>
                    <td width='55%'></td>
                    <td width='5%'>No PO</td>
                    <td width='1%'>:</td>
                  ...
                  <tr>
                    <td width='10%'><b>Detail Transaksi</b></td>
                    <td width='1%'>:</td>
                    <td width='20%' align='left'></td>
                    <td width='55%'></td>
                    <td width='5%'>Label</td>
                    <td width='1%'>:</td>
                    <td width='20%' align='left'><?= $label ?></td>
                  </tr>
                </table>
                ...
                <table border='1' class='table table-striped table-hover' width=100% cellpadding="2px" ; cellspacing="0"
                  ...
                  <thead>
                    <tr>
                      ...
                      <th style="background-color:#20B2AA; color: #ffffff" colspan="<?= cek_jumlah_size_orc2($tgl, $orc2); ?>">
                        <center>SIZE</center>
                      </th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td colspan="<?php $total_size = cek_jumlah_size_orc2($tgl, $orc2) + 9;
                      echo $total_size; ?>">
  ...
  Jumlah Karton : <?php $total_ctn = $no_karton3 + $tot_jmlh_karton2 + $tot_jmlh_karton3;
  echo $total_ctn; ?> Karton
