...
<table border="1px" id="example" class="table table-striped table-bordered data" style="font-size: 12px">
    ...
    <tr>
      ...
      if ($hasData) {
        if ($kelompok == 'full' OR $kelompok == 'mix' OR $kelompok == 'mix_color' OR $kelompok == 'ecer') {
          ...
          $query_size_header = mysqli_query(
            $koneksi,
            "SELECT C.size, C.cup
  ...
  GROUP BY C.size, C.cup"
          ...
          $jumlahColspan = mysqli_num_rows($query_size_header);
          if ($jumlahColspan == 0)
            $jumlahColspan = 1;
        }
      }
      ?>
      <th class="tengah theader" rowspan=2 style="vertical-align:middle; background: #254681;">
        <center>NO</center>
      </th>
      <th class="tengah theader" rowspan=2 style="vertical-align:middle; background: #254681;">
      ...
      <th class="tengah theader" rowspan=2 style="background: #254681;">
        <center>Isi Carton</center>
      </th>
      <?php if ($hasData && ($kelompok == 'full' OR $kelompok == 'mix' OR $kelompok == 'mix_color' OR $kelompok == 'ecer')) { ?>
        <th class="tengah theader" rowspan=2 style="background: #254681;">
          <center>QTY</center>
        </th>
      <?php } else if ($hasData && $kelompok == 'mix_style') {
        } else { ?>
          <th class="tengah theader" rowspan=2 style="background: #254681;">
            <center>QTY</center>
          </th>
  ...
  <tbody>
    <?php
    if ($hasData && $result && mysqli_num_rows($result) > 0) {
      $no = 1;
      $subtotal_qty = 0;
  ...
  ORDER BY F.urutan";
      ...
      // Belum ada data - tampilkan baris kosong dengan "-"
      ?>
      <tr>
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title">
          <font face="Calibri" color="red"><b>Edit QTY Produksi Bundle</b></font>
        </h4>
      </div>
      <!-- body modal -->
